        ...
        <div class="row">
            ...
            <div class="col-lg-3">
                ...
                <ul class="list-unstyled templatemo-accordion">
                    <li class="pb-3">
                       <a class="collapsed d-flex justify-content-between h3 text-decoration-none" href="#" onclick="location.href='shopCoat.jsp'">
                            Coat
                        </a>
                    </li>
                    <li class="pb-3">
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            <div class="card rounded-0">
                                <img class="card-img rounded-0 img-fluid" src="viewDetailProductBefore?productURL=assets/img/shop_13.jpg">
                            ...
                            <div class="card-body">
                                <a class="h3 text-decoration-none">White Coat</a>
