                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            ...
                            <div class="card-body">
                                <a href="detailPageForm.jsp" class="h3 text-decoration-none">Black Jacket</a>
                    ...
                    <div class="col-md-4">
                        <div class="card mb-4 product-wap rounded-0">
                            ...
                            <div class="card-body">
                                <a href="detailPageForm.jsp" class="h3 text-decoration-none">Blue Jacket</a>
                                <ul class="w-100 list-unstyled d-flex justify-content-between mb-0">
                                    <li>Free Size</li>
                                    <li class="pt-2">
                                        <span class="product-color-dot color-dot-red float-left rounded-circle ml-1"></span>
